...
use Google\Ads\GoogleAds\V16\Services\Client\AccountBudgetProposalServiceClient;
...
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupAssetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupAssetSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupBidModifierServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupCriterionCustomizerServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupCriterionLabelServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupCriterionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupCustomizerServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupExtensionSettingServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupFeedServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupLabelServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdGroupServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AdParameterServiceClient;
...
use Google\Ads\GoogleAds\V16\Services\Client\AssetGroupSignalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AssetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AssetSetAssetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AssetSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AudienceInsightsServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\AudienceServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BatchJobServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BiddingDataExclusionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BiddingSeasonalityAdjustmentServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BiddingStrategyServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BillingSetupServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\BrandSuggestionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignAssetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignAssetSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignBidModifierServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignBudgetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignConversionGoalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignCriterionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignCustomizerServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignDraftServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignExtensionSettingServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignFeedServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignGroupServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignLabelServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CampaignSharedSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionActionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionAdjustmentUploadServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionCustomVariableServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionGoalCampaignConfigServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionUploadServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionValueRuleServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ConversionValueRuleSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomAudienceServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomConversionGoalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerAssetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerAssetSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerClientLinkServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerConversionGoalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerCustomizerServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerExtensionSettingServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerFeedServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerLabelServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerLifecycleGoalServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerManagerLinkServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerNegativeCriterionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerSkAdNetworkConversionValueSchemaServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerUserAccessInvitationServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomerUserAccessServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomInterestServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\CustomizerAttributeServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ExperimentArmServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ExperimentServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ExtensionFeedItemServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedItemServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedItemSetLinkServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedItemSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedItemTargetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedMappingServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\FeedServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\GeoTargetConstantServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\GoogleAdsFieldServiceClient;
...
use Google\Ads\GoogleAds\V16\Services\Client\InvoiceServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanAdGroupKeywordServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanAdGroupServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanCampaignKeywordServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanCampaignServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanIdeaServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordPlanServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\KeywordThemeConstantServiceClient;
...
use Google\Ads\GoogleAds\V16\Services\Client\PaymentsAccountServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ProductLinkInvitationServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ProductLinkServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ReachPlanServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\RecommendationServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\RecommendationSubscriptionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\RemarketingActionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\SharedCriterionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\SharedSetServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\SmartCampaignSettingServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\SmartCampaignSuggestServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\ThirdPartyAppAnalyticsLinkServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\TravelAssetSuggestionServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\UserDataServiceClient;
use Google\Ads\GoogleAds\V16\Services\Client\UserListServiceClient;
